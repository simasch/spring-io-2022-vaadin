package ch.martinelli.vaadin.demo.data.generator;

import ch.martinelli.vaadin.demo.data.Role;
import ch.martinelli.vaadin.demo.data.entity.SamplePerson;
import ch.martinelli.vaadin.demo.data.entity.User;
import ch.martinelli.vaadin.demo.data.service.SamplePersonRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 5, 22, 0, 0, 0));
